...
export default function WhyFortuna() {
  ...
  return (
    <>
      ...
      <div className="text-center bg-black  bg-right-top bg-[length:500px_auto] bg-[url(/group-39969.png)]  bg-no-repeat">
        <div className="bg-[url(/dome-lines.svg.png)] bg-no-repeat bg-right-top">
